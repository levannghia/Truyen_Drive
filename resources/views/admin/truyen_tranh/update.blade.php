...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Cập nhật truyện tranh') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @if (isset($truyen))
                        <form action="{{ route('truyen-tranh.update',$truyen->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{asset('public/uploads/truyen_tranh/'.$truyen->image)}}" width="200" height="200" alt="">
                            </div>
                            <div class="mb-3">
